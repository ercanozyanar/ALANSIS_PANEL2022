    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        If TextBox1.Text <> "" Then
            ...
            If soru = vbYes Then
                ...
                cmd.CommandText = "DELETE FROM EO_ALANSIS_NARYARIM_MAMULDEPO WHERE ID='" & TextBox4.Text & "'"
                cmd.ExecuteNonQuery()
                conn2.Close()
                conn2.Open()
                cmd.Connection = conn2
    ...
    Private Sub Form28_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If TextBox1.Text <> "" Then
            Try
                ...
                cmd.CommandText = "SELECT* FROM EO_ALANSIS_NARYARIM_MAMULDEPO ORDER BY ID DESC"
        ...
        If TextBox1.Text = "" Then
            Try
                ...
                cmd.Connection = cnn
                cmd.CommandType = CommandType.Text
                cmd.CommandText = "SELECT* FROM EO_ALANSIS_NARYARIM_DEPO ORDER BY ID DESC"
                da.SelectCommand = cmd
                da.Fill(ds)
                DataGridView1.DataSource = ds.Tables(0).DefaultView
            Catch ex As Exception
