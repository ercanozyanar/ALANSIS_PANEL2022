...
Public Class Form48
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        '*** PALET KONTROL
        Form49.TextBox1.Text = TextBox1.Text
        Form49.Show()
    End Sub
    Private Sub Form48_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Application.Exit()
    End Sub
    Private Sub Form48_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cmd.CommandText = "Select TIP,PARTINO,SUM(TOPLAM_NET) As TOPLAM_NETKG,SUM(TOPLAM_BRUT) As TOPLAM_BRUTKG FROM EO_ALANSIS_ERIK_PANEL1 GROUP BY PARTINO,TIP"
        ...
        '*** PARTI BILGISI
        SqlConn.Open()
        Dim mySelectQuery20 As String = "SELECT PARTI FROM EO_ALANAR_ERIKSIP_ISLEM  WHERE ISEMRI='0' GROUP BY PARTI "
        ...
        '================================================================================================================================
        SqlConn.Open()
        Dim mySelectQuery1 As String = "SELECT* FROM EO_ALANSIS_ERIKISLEM;"
        ...
        SqlConn.Close()
        SqlConn.Open()
        Dim mySelectQuery2 As String = "SELECT* FROM EO_ALANSIS_ERIKBOLGE;"
        ...
        SqlConn.Close()
        SqlConn.Open()
        Dim mySelectQuery3 As String = "SELECT* FROM EO_ALANSIS_ERIKEBAT;"
        ...
        SqlConn.Close()
        SqlConn.Open()
        Dim mySelectQuery4 As String = "SELECT* FROM EO_ALANSIS_ERIKERIKISLEM;"
        ...
        While reader4.Read()
            ComboBox7.Items.Add(reader4("ERIKISLEM"))
        End While
        reader4.Close()
        SqlConn.Close()
        SqlConn.Close()
        SqlConn.Open()
        Dim mySelectQuery5 As String = "SELECT* FROM EO_ALANSIS_ERIKODA;"
        ...
        '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        SqlConn.Open()
        Dim mySelectQuery6 As String = "SELECT* FROM EO_ALANSIS_ERIKCESIT;"
        ...
        '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        SqlConn.Open()
        Dim mySelectQuery7 As String = "SELECT* FROM EO_ALANSIS_ERIKURETIMTIPI;"
            ...
            If TextBox12.Text <> "" Then
                If TextBox4.Text > 0 Then
                    ...
                    If TextBox1.Text = "" Then
                        serinum = "2800013" & Format(DateTime.Today, "ddmmyy") & TextBox5.Text & TextBox4.Text
                        ...
                        dosya = dosya.Replace("@STOKKODU", "HMD01-08-0001")
                        dosya = dosya.Replace("@MUSTERI", "HAMMADDE ERIK") ' & "VIYOL:" & +ComboBox2.Text)
                    ...
                    If TextBox1.Text <> "" Then
                        ...
                        Else
                            ...
                            '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                            SqlConn.Open()
                            Dim mySelectQuery2 As String = "SELECT PARTINO, COUNT(ID) AS SAYI FROM EO_ALANSIS_ERIK_MAMULDEPO WHERE PARTINO='" & TextBox1.Text & "'GROUP BY PARTINO;"
                            Dim SqlComm2 As New System.Data.SqlClient.SqlCommand(mySelectQuery2, SqlConn)
                            Dim reader2 As System.Data.SqlClient.SqlDataReader
                            reader2 = SqlComm2.ExecuteReader()
                            While reader2.Read()
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Form11.Text = "ALANSIS ERIK URETIM USER :" + TextBox16.Text
    ...
    Private Sub Button17_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Form12.Text = "ALANSIS ERIK URETIM USER :" + TextBox16.Text
    ...
    Private Sub ComboBox18_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox18.SelectedIndexChanged
        On Error Resume Next
        SqlConn.Open()
        Dim mySelectQuery21 As String = "SELECT* FROM EO_ALANAR_ERIKSIP_ISLEM WHERE ISEMRI='0' AND PARTI='" & ComboBox18.Text & "';"
        Dim SqlComm21 As New System.Data.SqlClient.SqlCommand(mySelectQuery21, SqlConn)
        Dim reader21 As System.Data.SqlClient.SqlDataReader
        reader21 = SqlComm21.ExecuteReader()
        While reader21.Read()
    ...
    Private Sub Button3_Click_1(sender As Object, e As EventArgs) Handles Button3.Click
        On Error Resume Next
        Form56.Text = "ALANSIS ERIK HAMMADDE YUKLEME URETIM USER :" + TextBox16.Text
        Form56.TextBox14.Text = TextBox16.Text
        Form56.Show()
    End Sub

    Private Sub Button17_Click_1(sender As Object, e As EventArgs) Handles Button17.Click
        Form42.TextBox1.Text = ComboBox18.Text
        Form42.TextBox3.Text = "ERIK"
        Form42.Show()
    End Sub
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        conn3.Open()
        cmd1.Connection = conn3
        cmd1.CommandText = "UPDATE EO_ALANSIS_SATIS SET ISEMRI='1' WHERE PARTI='" & ComboBox18.Text & "'"
        cmd1.ExecuteNonQuery()
        conn3.Close()
        conn3.Open()
        cmd2.Connection = conn3
        cmd2.CommandText = "UPDATE EO_ALANAR_ERIKSIP_ISLEM SET ISEMRI='1' WHERE PARTI='" & ComboBox18.Text & "'"
    ...
    Private Sub Button19_Click(sender As Object, e As EventArgs) Handles Button19.Click
        On Error Resume Next
        Form54.TextBox1.Text = ComboBox18.Text
        Form54.Show()
    End Sub
