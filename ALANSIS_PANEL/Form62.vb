...
Public Class Form62
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        Form8.Show()
    End Sub
    Private Sub Form62_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Application.Exit()
    End Sub
    Private Sub Form62_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cmd.CommandText = "Select TIP,PARTINO,SUM(TOPLAM_NET) As TOPLAM_NETKG,SUM(TOPLAM_BRUT) As TOPLAM_BRUTKG FROM EO_ALANSIS_NAR_PANEL1 GROUP BY PARTINO,TIP"
        ...
        '*** PARTI BILGISI
        SqlConn.Open()
        Dim mySelectQuery20 As String = "SELECT PARTI FROM EO_ALANAR_NARSIP_ISLEM  WHERE ISEMRI='0' GROUP BY PARTI "
        ...
        '================================================================================================================================
        SqlConn.Open()
        Dim mySelectQuery1 As String = "SELECT* FROM EO_ALANSIS_NARBAHCEPARSEL;"
        Dim SqlComm1 As New System.Data.SqlClient.SqlCommand(mySelectQuery1, SqlConn)
        Dim reader1 As System.Data.SqlClient.SqlDataReader
        reader1 = SqlComm1.ExecuteReader()
        While reader1.Read()
            ComboBox3.Items.Add(reader1("BAHCE"))
        End While
        reader1.Close()
        SqlConn.Close()
        SqlConn.Open()
        ...
        '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        SqlConn.Open()
        Dim mySelectQuery8 As String = "SELECT* FROM EO_ALANSIS_NARYARDMALTIPI;"
        ...
        While reader8.Read()
            ComboBox9.Items.Add(reader8("YARD_MAL_TIPI"))
        End While
        reader8.Close()
        SqlConn.Close()
        '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Private Sub Button14_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button14.Click
        ...
        Dim barkod
        barkod = ""
        If ComboBox1.Text = "" Or TextBox14.Text = "" Or ComboBox4.Text = "" Or ComboBox6.Text = "" Or ComboBox7.Text = "" Or ComboBox11.Text = "" Or ComboBox12.Text = "" Then
            ...
            If TextBox12.Text <> "" Then
                If TextBox4.Text > 0 Then
                    ...
                    If TextBox1.Text = "" Then
                        ...
                        cmd1.CommandText = "INSERT INTO EO_ALANSIS_NAR_DEPO (TARIH, SERI, MIKTAR, BOLGE,BOY, ISLEM, NAR_ISLEM, ODA, KALINTI,DARA,BRUT,DEPO,TIP,CESIT,URETIM_TIPI,USR,ACIKLAMA,RENK,YARD_MAL_TIPI) VALUES ('" & DateTime.Now & "', '" & serinum & "','" & net & "', '" & ComboBox4.Text & "', '" & ComboBox5.Text & "','" & TextBox14.Text & "'  ,'" & ComboBox7.Text & "','" & ComboBox6.Text & "','" & ComboBox1.Text & "','" & TextBox6.Text & "','" & TextBox4.Text & "','10','HAMMADDE','" & ComboBox11.Text & "','" & ComboBox12.Text & "','" & TextBox16.Text & "','" & RichTextBox1.Text & "','" & ComboBox2.Text & "','" & ComboBox9.Text & "')"
                        ...
                        dosya = dosya.Replace("@KALINTI", TextBox13.Text)
                    ...
                    If TextBox1.Text <> "" Then
                        ...
                        Else
                            ...
                            conn1.Open()
                            cmd1.Connection = conn1
                            cmd1.CommandText = "INSERT INTO EO_ALANSIS_NAR_MAMULDEPO (TARIH,STOK_KODU, SERI, MIKTAR, BOLGE,BOY, ISLEM, NAR_ISLEM, ODA, KALINTI,DARA,BRUT,DEPO,TIP,PARTINO,URETIM_TIPI,CESIT,USR,ACIKLAMA,RENK,YARD_MAL_TIPI) VALUES ('" & DateTime.Now & "','" & TextBox9.Text & "', '" & serinum & "','" & net & "', '" & ComboBox4.Text & "', '" & ComboBox5.Text & "','" & TextBox14.Text & "'  ,'" & ComboBox7.Text & "','" & ComboBox6.Text & "','" & ComboBox1.Text & "','" & TextBox6.Text & "','" & TextBox4.Text & "','10','MAMUL','" & TextBox1.Text & "','" & ComboBox12.Text & "','" & ComboBox11.Text & "','" & TextBox16.Text & "','" & RichTextBox1.Text & "','" & ComboBox2.Text & "','" & ComboBox9.Text & "')"
                            cmd1.ExecuteNonQuery()
                            conn1.Close()
                            '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                            conn1.Open()
    ...
    Private Sub Button10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button10.Click
        ...
        Else
            ...
            If TextBox1.Text = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_ALANSIS_NAR_DEPO (TARIH, SERI, MIKTAR, BOLGE,BOY, ISLEM, NAR_ISLEM, ODA, KALINTI,DARA,BRUT,DEPO,TIP,CESIT,URETIM_TIPI,USR,ACIKLAMA,RENK,YARD_MAL_TIPI) VALUES ('" & DateTime.Now & "', '" & serinum & "','" & net & "', '" & ComboBox4.Text & "', '" & ComboBox5.Text & "','" & TextBox14.Text & "'  ,'" & ComboBox7.Text & "','" & ComboBox6.Text & "','" & ComboBox1.Text & "','" & TextBox6.Text & "','" & TextBox4.Text & "','20','YARIMAMUL_HAMMADDE','" & ComboBox11.Text & "','" & ComboBox12.Text & "','" & TextBox16.Text & "','" & RichTextBox1.Text & "','" & ComboBox2.Text & "','" & ComboBox9.Text & "')"
                cmd1.ExecuteNonQuery()
                conn1.Close()
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                SqlConn.Open()
    ...
    Private Sub Button12_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button12.Click
        ...
        Else
            ...
            If TextBox1.Text = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_ALANSIS_NAR_DEPO (TARIH, SERI, MIKTAR, BOLGE,BOY, ISLEM, NAR_ISLEM, ODA, KALINTI,DARA,BRUT,DEPO,TIP,CESIT,URETIM_TIPI,USR,ACIKLAMA,RENK) VALUES ('" & DateTime.Now & "', '" & serinum & "','" & net & "', '" & ComboBox4.Text & "', '" & ComboBox5.Text & "','" & TextBox14.Text & "'  ,'" & ComboBox7.Text & "','" & ComboBox6.Text & "','" & ComboBox1.Text & "','" & TextBox6.Text & "','" & TextBox4.Text & "','40','2KALITE_HAMMADDE','" & ComboBox11.Text & "','" & ComboBox12.Text & "','" & TextBox16.Text & "','" & RichTextBox1.Text & "','" & ComboBox2.Text & "')"
                cmd1.ExecuteNonQuery()
                conn1.Close()
                '---------------------------------------------------------------------------------------------------
                SqlConn.Open()
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        Else
            ...
            If TextBox1.Text = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_ALANSIS_NAR_DEPO (TARIH, SERI, MIKTAR, BOLGE,BOY, ISLEM, NAR_ISLEM, ODA, KALINTI,DARA,BRUT,DEPO,TIP,CESIT,URETIM_TIPI,USR,ACIKLAMA,RENK,YARD_MAL_TIPI) VALUES ('" & DateTime.Now & "', '" & serinum & "','" & net & "', '" & ComboBox4.Text & "', '" & ComboBox5.Text & "','" & TextBox14.Text & "'  ,'" & ComboBox7.Text & "','" & ComboBox6.Text & "','" & ComboBox1.Text & "','" & TextBox6.Text & "','" & TextBox4.Text & "','50','COP_HAMMADDE','" & ComboBox11.Text & "','" & ComboBox12.Text & "','" & TextBox16.Text & "','" & RichTextBox1.Text & "','" & ComboBox2.Text & "','" & ComboBox9.Text & "')"
                cmd1.ExecuteNonQuery()
                conn1.Close()
                '---------------------------------------------------------------------------------------------------
                SqlConn.Open()
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Form11.Text = "ALANSIS NAR URETIM USER :" + TextBox16.Text
    ...
    Private Sub Button17_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Form12.Text = "ALANSIS NAR URETIM USER :" + TextBox16.Text
    ...
    Private Sub ComboBox18_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox18.SelectedIndexChanged
        On Error Resume Next
        SqlConn.Open()
        Dim mySelectQuery21 As String = "SELECT* FROM EO_ALANAR_NARSIP_ISLEM WHERE ISEMRI='0' AND PARTI='" & ComboBox18.Text & "';"
        Dim SqlComm21 As New System.Data.SqlClient.SqlCommand(mySelectQuery21, SqlConn)
        Dim reader21 As System.Data.SqlClient.SqlDataReader
        reader21 = SqlComm21.ExecuteReader()
        While reader21.Read()
    ...
    Private Sub Button3_Click_1(sender As Object, e As EventArgs) Handles Button3.Click
        '***HAMMADDE YUKLE
        Form65.Text = "ALANSIS NAR HAMMADDE YUKLEME URETIM USER :" + TextBox16.Text
        Form65.TextBox14.Text = TextBox16.Text
        Form65.Show()
    End Sub

    Private Sub Button17_Click_1(sender As Object, e As EventArgs) Handles Button17.Click
        Form42.TextBox1.Text = ComboBox18.Text
        Form42.TextBox3.Text = "NAR"
        Form42.Show()
    End Sub
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        cmd2.CommandText = "UPDATE EO_ALANAR_NARSIP_ISLEM SET ISEMRI='1' WHERE PARTI='" & ComboBox18.Text & "'"
    ...
    Private Sub Button19_Click(sender As Object, e As EventArgs) Handles Button19.Click
        On Error Resume Next
        Form63.TextBox1.Text = ComboBox18.Text
        Form63.Show()
    End Sub
