    ...
    Private Sub Form40_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If TextBox1.Text <> "" Then
            Try
                ...
                cmd.CommandText = "SELECT* FROM EO_ALANSIS_KIVI_MAMULDEPO WHERE TIP='STOK' ORDER BY ID DESC"
        ...
        If TextBox1.Text = "" Then
            Try
                ...
                cmd.Connection = cnn
                cmd.CommandType = CommandType.Text
                cmd.CommandText = "SELECT* FROM EO_ALANSIS_KIVI_DEPO WHERE TIP='STOK' ORDER BY ID DESC"
                da.SelectCommand = cmd
                da.Fill(ds)
                DataGridView1.DataSource = ds.Tables(0).DefaultView
            Catch ex As Exception
        ...
        '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        SqlConn.Open()
        Dim mySelectQuery1 As String = "SELECT* FROM EO_ALANAR_KIVISIP_ISLEM';"
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        If indeks = "0" Then
            ...
            If TextBox1.Text = "" Then
                If soru = vbYes Then
                    ...
                    cmd2.CommandText = "DELETE EO_ALANSIS_KIVI_DEPO WHERE ID='" & TextBox2.Text & "'"
                    ...
                    Try
                        ...
                        cmd.Connection = cnn
                        cmd.CommandType = CommandType.Text
                        cmd.CommandText = "SELECT* FROM EO_ALANSIS_KIVI_DEPO WHERE PARTINO='STOK' ORDER BY ID DESC"
                        da.SelectCommand = cmd
                        da.Fill(ds)
                        DataGridView1.DataSource = ds.Tables(0).DefaultView
                    Catch ex As Exception
            ...
            If TextBox1.Text <> "" Then
                If soru = vbYes Then
                    conn2.Open()
                    cmd2.Connection = conn2
                    cmd2.CommandText = "DELETE EO_ALANSIS_KIVI_MAMULDEPO WHERE ID='" & TextBox2.Text & "'"
                    cmd2.ExecuteNonQuery()
                    conn2.Close()
                    '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                    conn2.Open()
                    ...
                    Try
                        ...
                        cmd.Connection = cnn
                        cmd.CommandType = CommandType.Text
                        cmd.CommandText = "SELECT* FROM EO_ALANSIS_KIVI_MAMULDEPO WHERE PARTINO='STOK' ORDER BY ID DESC"
                        da.SelectCommand = cmd
                        da.Fill(ds)
                        DataGridView1.DataSource = ds.Tables(0).DefaultView
                    Catch ex As Exception
        ...
        If indeks = "1" Then
            If TextBox1.Text = "" Then
                ...
                cmd1.CommandText = "UPDATE EO_ALANSIS_KIVI_DEPO SET TIP='HAMMADDE',DEPO='10' WHERE ID='" & TextBox2.Text & "' "
            ...
            If TextBox1.Text <> "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "UPDATE EO_ALANSIS_KIVI_MAMULDEPO SET DEPO='10',PARTINO='" & ComboBox1.Text & "' WHERE ID='" & TextBox2.Text & "' "
                cmd1.ExecuteNonQuery()
                conn1.Close()
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                conn2.Open()
