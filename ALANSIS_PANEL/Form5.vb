    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            If TextBox4.Text <> "" And serikont1 = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_SARF_TUKETIM_SERI (SIPARIS, TARIH, STOK_KODU, STOK_ADI, SERI, MIKTAR, ZAMAN, TUKETIM, INDEKS,USR) VALUES ('" & TextBox4.Text & "', '" & DateTime.Today & "','" & TextBox2.Text & "', '" & TextBox3.Text & "','" & seri & "'  ,'" & MIKTAR & "','" & DateTime.Now & "' ,'0','0','" & TextBox14.Text & "')"
                cmd1.ExecuteNonQuery()
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                conn1.Close()
                '---------------------------------------------------------------------------------------------------
            ...
            If TextBox5.Text <> "" And serikont2 = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_SARF_TUKETIM_SERI (SIPARIS, TARIH, STOK_KODU, STOK_ADI, SERI, MIKTAR, ZAMAN, TUKETIM, INDEKS,USR) VALUES ('" & TextBox5.Text & "', '" & DateTime.Today & "','" & TextBox2.Text & "', '" & TextBox3.Text & "','" & seri & "'  ,'" & MIKTAR & "','" & DateTime.Now & "' ,'0','0','" & TextBox14.Text & "')"
                cmd1.ExecuteNonQuery()
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                conn1.Close()
                '---------------------------------------------------------------------------------------------------
            ...
            If TextBox6.Text <> "" And serikont3 = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_SARF_TUKETIM_SERI (SIPARIS, TARIH, STOK_KODU, STOK_ADI, SERI, MIKTAR, ZAMAN, TUKETIM, INDEKS,USR) VALUES ('" & TextBox6.Text & "', '" & DateTime.Today & "','" & TextBox2.Text & "', '" & TextBox3.Text & "','" & seri & "'  ,'" & MIKTAR & "','" & DateTime.Now & "' ,'0','0','" & TextBox14.Text & "')"
                cmd1.ExecuteNonQuery()
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                conn1.Close()
                '---------------------------------------------------------------------------------------------------
            ...
            If TextBox7.Text <> "" And serikont4 = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_SARF_TUKETIM_SERI (SIPARIS, TARIH, STOK_KODU, STOK_ADI, SERI, MIKTAR, ZAMAN, TUKETIM, INDEKS,USR) VALUES ('" & TextBox7.Text & "', '" & DateTime.Today & "','" & TextBox2.Text & "', '" & TextBox3.Text & "','" & seri & "'  ,'" & MIKTAR & "','" & DateTime.Now & "' ,'0','0','" & TextBox14.Text & "')"
                cmd1.ExecuteNonQuery()
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                conn1.Close()
                '---------------------------------------------------------------------------------------------------
            ...
            If TextBox8.Text <> "" And serikont5 = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_SARF_TUKETIM_SERI (SIPARIS, TARIH, STOK_KODU, STOK_ADI, SERI, MIKTAR, ZAMAN, TUKETIM, INDEKS,USR) VALUES ('" & TextBox8.Text & "', '" & DateTime.Today & "','" & TextBox2.Text & "', '" & TextBox3.Text & "','" & seri & "'  ,'" & MIKTAR & "','" & DateTime.Now & "' ,'0','0','" & TextBox14.Text & "')"
                cmd1.ExecuteNonQuery()
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                conn1.Close()
                '---------------------------------------------------------------------------------------------------
            ...
            If TextBox9.Text <> "" And serikont6 = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_SARF_TUKETIM_SERI (SIPARIS, TARIH, STOK_KODU, STOK_ADI, SERI, MIKTAR, ZAMAN, TUKETIM, INDEKS,USR) VALUES ('" & TextBox9.Text & "', '" & DateTime.Today & "','" & TextBox2.Text & "', '" & TextBox3.Text & "','" & seri & "'  ,'" & MIKTAR & "','" & DateTime.Now & "' ,'0','0','" & TextBox14.Text & "')"
                cmd1.ExecuteNonQuery()
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                conn1.Close()
                '---------------------------------------------------------------------------------------------------
            ...
            If TextBox10.Text <> "" And serikont7 = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_SARF_TUKETIM_SERI (SIPARIS, TARIH, STOK_KODU, STOK_ADI, SERI, MIKTAR, ZAMAN, TUKETIM, INDEKS,USR) VALUES ('" & TextBox10.Text & "', '" & DateTime.Today & "','" & TextBox2.Text & "', '" & TextBox3.Text & "','" & seri & "'  ,'" & MIKTAR & "','" & DateTime.Now & "' ,'0','0','" & TextBox14.Text & "')"
                cmd1.ExecuteNonQuery()
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                conn1.Close()
                '---------------------------------------------------------------------------------------------------
            ...
            If TextBox11.Text <> "" And serikont8 = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_SARF_TUKETIM_SERI (SIPARIS, TARIH, STOK_KODU, STOK_ADI, SERI, MIKTAR, ZAMAN, TUKETIM, INDEKS,USR) VALUES ('" & TextBox11.Text & "', '" & DateTime.Today & "','" & TextBox2.Text & "', '" & TextBox3.Text & "','" & seri & "'  ,'" & MIKTAR & "','" & DateTime.Now & "' ,'0','0','" & TextBox14.Text & "')"
                cmd1.ExecuteNonQuery()
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                conn1.Close()
                '---------------------------------------------------------------------------------------------------
            ...
            If TextBox12.Text <> "" And serikont9 = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_SARF_TUKETIM_SERI (SIPARIS, TARIH, STOK_KODU, STOK_ADI, SERI, MIKTAR, ZAMAN, TUKETIM, INDEKS,USR) VALUES ('" & TextBox12.Text & "', '" & DateTime.Today & "','" & TextBox2.Text & "', '" & TextBox3.Text & "','" & seri & "'  ,'" & MIKTAR & "','" & DateTime.Now & "' ,'0','0','" & TextBox14.Text & "')"
                cmd1.ExecuteNonQuery()
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                conn1.Close()
                '---------------------------------------------------------------------------------------------------
            ...
            If TextBox13.Text <> "" And serikont10 = "" Then
                ...
                conn1.Open()
                cmd1.Connection = conn1
                cmd1.CommandText = "INSERT INTO EO_SARF_TUKETIM_SERI (SIPARIS, TARIH, STOK_KODU, STOK_ADI, SERI, MIKTAR, ZAMAN, TUKETIM, INDEKS,USR) VALUES ('" & TextBox13.Text & "', '" & DateTime.Today & "','" & TextBox2.Text & "', '" & TextBox3.Text & "','" & seri & "'  ,'" & MIKTAR & "','" & DateTime.Now & "' ,'0','0','" & TextBox14.Text & "')"
                cmd1.ExecuteNonQuery()
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                conn1.Close()
                '---------------------------------------------------------------------------------------------------
