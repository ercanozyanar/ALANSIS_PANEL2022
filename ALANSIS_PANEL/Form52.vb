...
Public Class Form52
    ...
    Private Sub Form52_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If TextBox1.Text = "" Then '
            ...
            Try
                ...
                cmd.CommandText = "SELECT* FROM EO_ALANSIS_ERIK_DEPO WHERE TIP='" & TextBox3.Text & "' ORDER BY ID DESC"
        ...
        If TextBox1.Text <> "" Then '
            ...
            Try
                ...
                cmd.Connection = cnn
                cmd.CommandType = CommandType.Text
                cmd.CommandText = "SELECT* FROM EO_ALANSIS_ERIK_MAMULDEPO WHERE PARTINO='" & TextBox1.Text & "' AND TIP='" & TextBox3.Text & "' ORDER BY ID DESC"
                da.SelectCommand = cmd
                da.Fill(ds)
                DataGridView1.DataSource = ds.Tables(0).DefaultView
            Catch ex As Exception
        ...
        If indeks = "1" Then
            ...
            If soru = vbYes Then
                If TextBox1.Text = "" Then
                    ...
                    cmd2.CommandText = "DELETE EO_ALANSIS_ERIK_DEPO WHERE ID='" & idx & "'"
                    ...
                    Try
                        ...
                        cmd.Connection = cnn
                        cmd.CommandType = CommandType.Text
                        cmd.CommandText = "SELECT* FROM EO_ALANSIS_ERIK_DEPO ORDER BY ID DESC"
                        da.SelectCommand = cmd
                        da.Fill(ds)
                        DataGridView1.DataSource = ds.Tables(0).DefaultView
                    Catch ex As Exception
                ...
                If TextBox1.Text <> "" Then
                    ...
                    conn2.Open()
                    cmd2.Connection = conn2
                    cmd2.CommandText = "DELETE EO_ALANSIS_ERIK_MAMULDEPO WHERE ID='" & idx & "'"
                    cmd2.ExecuteNonQuery()
                    conn2.Close()
                    '------------------------------------------------------------------------------
                    conn2.Open()
                    ...
                    Try
                        ...
                        cmd.Connection = cnn
                        cmd.CommandType = CommandType.Text
                        cmd.CommandText = "SELECT* FROM EO_ALANSIS_ERIK_MAMULDEPO WHERE PARTINO='" & TextBox1.Text & "' ORDER BY ID DESC"
                        da.SelectCommand = cmd
                        da.Fill(ds)
                        DataGridView1.DataSource = ds.Tables(0).DefaultView
                    Catch ex As Exception
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If TextBox1.Text = "" Then
            ...
            conn2.Open()
            cmd2.Connection = conn2
            cmd2.CommandText = "UPDATE EO_ALANSIS_ERIK_DEPO SET MIKTAR='" & TextBox2.Text & "',BOLGE='" & ComboBox4.Text & "',ISLEM='" & ComboBox3.Text & "',ERIK_ISLEM='" & ComboBox7.Text & "',ODA='" & ComboBox6.Text & "',KALINTI='" & ComboBox1.Text & "' WHERE ID='" & idx & "'"
            cmd2.ExecuteNonQuery()
            conn2.Close()
            '---------------------------------------------------------------------------------------------------
            SqlConn.Open()
            Dim mySelectQuery1 As String = "SELECT* FROM EO_ALANSIS_ERIK_DEPO WHERE SERI='" & serikontrol & "';"
            ...
            While reader1.Read()
                ...
                nar_islem = reader1("ERIK_ISLEM").ToString()
            ...
            dosya = dosya.Replace("@MUSTERI", "HAMMADDE ERIK")
        ...
        If TextBox1.Text <> "" Then
            ...
            conn2.Open()
            cmd2.Connection = conn2
            cmd2.CommandText = "UPDATE EO_ALANSIS_ERIK_MAMULDEPO SET MIKTAR='" & TextBox2.Text & "',BOLGE='" & ComboBox4.Text & "',ISLEM='" & ComboBox3.Text & "',ERIK_ISLEM='" & ComboBox7.Text & "',ODA='" & ComboBox6.Text & "',KALINTI='" & ComboBox1.Text & "' WHERE ID='" & idx & "'"
            cmd2.ExecuteNonQuery()
            conn2.Close()
            '---------------------------------------------------------------------------------------------------
            SqlConn.Open()
            Dim mySelectQuery1 As String = "SELECT* FROM EO_ALANSIS_ERIK_MAMULDEPO WHERE SERI='" & serikontrol & "';"
            Dim SqlComm1 As New System.Data.SqlClient.SqlCommand(mySelectQuery1, SqlConn)
            Dim reader1 As System.Data.SqlClient.SqlDataReader
            reader1 = SqlComm1.ExecuteReader()
            While reader1.Read()
