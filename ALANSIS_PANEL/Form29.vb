...
Public Class Form29
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        '*** PALET KONTROL
        Form31.TextBox1.Text = TextBox1.Text
        Form31.Show()
    End Sub
    ...
    Private Sub Form29_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '*** PARTI BILGISI
        SqlConn.Open()
        Dim mySelectQuery20 As String = "SELECT PARTI FROM EO_ALANAR_KIRAZSIP_ISLEM  WHERE ISEMRI='0' GROUP BY PARTI "
        ...
        While reader4.Read()
            ComboBox7.Items.Add(reader4("KIRAZISLEM"))
        End While
        reader4.Close()
        SqlConn.Close()
        '================================================================================================================================
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Form11.Text = "ALANSIS KIRAZ URETIM USER :" + TextBox16.Text
    ...
    Private Sub Button17_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Form12.Text = "ALANSIS KIRAZ URETIM USER :" + TextBox16.Text
    ...
    Private Sub ComboBox18_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox18.SelectedIndexChanged
        On Error Resume Next
        SqlConn.Open()
        Dim mySelectQuery21 As String = "SELECT* FROM EO_ALANAR_KIRAZSIP_ISLEM WHERE ISEMRI='0' AND PARTI='" & ComboBox18.Text & "';"
        Dim SqlComm21 As New System.Data.SqlClient.SqlCommand(mySelectQuery21, SqlConn)
        Dim reader21 As System.Data.SqlClient.SqlDataReader
        reader21 = SqlComm21.ExecuteReader()
        While reader21.Read()
    ...
    Private Sub Button3_Click_1(sender As Object, e As EventArgs) Handles Button3.Click
        '***HAMMADDE YUKLE
        Form33.Text = "ALANSIS KIRAZ HAMMADDE YUKLEME URETIM USER :" + TextBox16.Text
        Form33.TextBox14.Text = TextBox16.Text
        Form33.Show()
    End Sub
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        cmd2.CommandText = "UPDATE EO_ALANAR_KIRAZSIP_ISLEM SET ISEMRI='1' WHERE PARTI='" & ComboBox18.Text & "'"
